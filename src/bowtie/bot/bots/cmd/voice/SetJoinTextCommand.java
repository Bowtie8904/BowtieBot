 ...
 *
 */
public class SetJoinTextCommand extends Command
{
    private Main main;
     ...
     * @param permission
     */
    public SetJoinTextCommand(String[] validExpressions, int permission, Main main)
    {
    ...
    public void execute(CommandEvent event)
    {
        ...
        main.getDatabase().setJoinText(event.getGuild().getStringID(), text);

        this.main.getBot().sendMessage("The new text will be played when someone joins the "
    ...
    public EmbedObject getHelp(GuildObject guild)
    {
        ...
        builder.withAuthorName("Set Custom Voice Join Text Command");
        ...
        builder.withDescription("|  Sets a custom text that the bot will say if someone \n"
                ...
                + "|  \n"
                + "|  If you want to use the username of the user that joined you have\n"
                + "|  to insert < username > .\n"
                + "|");

        builder.appendField(
                "|  Usage:",
                "|  " + guild.getPrefix() + "setjointext Hello < username > .\n"
                        + "|  \n"
                        + "|  " + guild.getPrefix() + "setjointext Hello you < list=animals > .\n"
                        + "|  \n"
                        + "|  " + guild.getPrefix() + "setjointext Hello < username > , please contact \n"
                        + "|  < group=admins > for your roles.\n"
                        + "|", false);
