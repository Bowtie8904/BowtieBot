 ...
 *
 */
public class VoiceChannelLeaveHandler implements IListener<UserVoiceChannelLeaveEvent>
{
    private Main main;
    private Pattern pat = Pattern.compile("(<[\\w|1-9\\s=]+>)");
    private SplittableRandom r;

    public VoiceChannelLeaveHandler(Main main)
    {
        this.main = main;
    ...
    public void handle(UserVoiceChannelLeaveEvent event)
    {
                ...
                && !event.getUser().isBot())
        {
            ...
            String text = main.getDatabase().getLeaveText(event.getGuild().getStringID());
