...
import bowtie.bot.bots.cmd.activation.ActivateCommand;
import bowtie.bot.bots.cmd.activation.ActivationsCommand;
import bowtie.bot.bots.cmd.activation.DeactivateCommand;
import bowtie.bot.bots.cmd.activation.GrantPremiumCommand;
import bowtie.bot.bots.cmd.activation.MyActivationsCommand;
import bowtie.bot.bots.cmd.activation.PremiumStatusCommand;
import bowtie.bot.bots.cmd.activation.RevokePremiumCommand;
...
import bowtie.bot.bots.cmd.files.DeleteFileCommand;
import bowtie.bot.bots.cmd.files.DirectoryCommand;
import bowtie.bot.bots.cmd.files.DiskSpaceCommand;
import bowtie.bot.bots.cmd.files.DownloadFileCommand;
...
import bowtie.bot.bots.cmd.votes.GetVotesCommand;
import bowtie.bot.bots.cmd.votes.ResetVotesCommand;
...
public class Main
{
    ...
    public static final boolean NEEDS_ACTIVATION = true;
    ...
    public static final String BOT_ID = Properties.getValueOf("botID");
    public static final String AUTH_PASSWORD = Properties.getValueOf("authPass");
    ...
    public Main()
    {
        ...
        VoterUpdater.setMain(this);

        this.bot = new Bot(Properties.getValueOf("token"), "bt-");
    ...
    private void setupCommandHandler()
    {
        ...
        commandHandler.addCommand(new GetVotesCommand(new String[]
        {
                "votes"
        }, UserPermissions.USER, this));

        commandHandler.addCommand(new ResetVotesCommand(new String[]
        {
                "resetvotes"
        }, UserPermissions.CREATOR, this));
        ...
        commandHandler.addCommand(new ActivateCommand(new String[]
        {
                "activate"
        }, UserPermissions.USER, bot, this));

        commandHandler.addCommand(new DeactivateCommand(new String[]
        {
                "deactivate"
        }, UserPermissions.USER, bot, this));

        commandHandler.addCommand(new MyActivationsCommand(new String[]
        {
                "myactivations"
        }, UserPermissions.USER, bot, this));

        commandHandler.addCommand(new ActivationsCommand(new String[]
        {
                "activations"
        }, UserPermissions.CREATOR, bot, this));

        commandHandler.addCommand(new GrantPremiumCommand(new String[]
        {
                "grantpremium"
        }, UserPermissions.CREATOR, bot, this));

        commandHandler.addCommand(new RevokePremiumCommand(new String[]
        {
                "revokepremium"
        }, UserPermissions.CREATOR, bot, this));

        commandHandler.addCommand(new PremiumStatusCommand(new String[]
        {
                "premium"
        }, UserPermissions.USER, bot, this));
        ...
        commandHandler.addCommand(new DeleteFileCommand(new String[]
        {
                "deletefile", "delete"
        }, UserPermissions.CREATOR, bot, this));

        commandHandler.addCommand(new DirectoryCommand(new String[]
        {
                "dir", "directory"
        }, UserPermissions.CREATOR, bot, this));

        commandHandler.addCommand(new DownloadFileCommand(new String[]
        {
                "download"
        }, UserPermissions.CREATOR, bot, this));
    ...
    public void setHomeGuild(IGuild guild)
    {
        if (guild == null)
        {
            Bot.errorLog.print(this, "Home guild is null.");
        }
        this.homeGuild = guild;
    }

    public IGuild getHomeGuild()
    {
        return this.homeGuild;
    }

    public void setTempChannel(IChannel channel)
    {
        if (channel == null)
        {
            Bot.errorLog.print(this, "Temp channel is null.");
        }
        this.tmpPremiumChannel = channel;
    }

    public IChannel getTempChannel()
    {
        return this.tmpPremiumChannel;
    }
}